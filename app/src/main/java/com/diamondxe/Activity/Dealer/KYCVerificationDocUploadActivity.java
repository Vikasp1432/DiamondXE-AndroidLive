...
public class KYCVerificationDocUploadActivity extends SuperActivity implements RecyclerInterface, DialogItemClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kyc_verification_doc_upload);
    ...
    public void onClick(View view)
    {
        ...
        else if(id == R.id.dob_lin)
        {
            ...
            CommonUtility.datePicker(context, KYCVerificationDocUploadActivity.this, dob, "dob", 0, System.currentTimeMillis());
        }
