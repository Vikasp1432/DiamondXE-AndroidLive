...
public class AddShippingAddressActivity extends SuperActivity implements RecyclerInterface {
    ...
    public void onAddShippingAPI(boolean showLoader)
    {
        if (Utils.isNetworkAvailable(context))
        {
            urlParameter = new HashMap<String, String>();

            // If Address is Edit Then Send addressID
            if(Constant.editShippingAddress.equalsIgnoreCase("yes"))
            {
            ...
            urlParameter.put("addressType", ""+ "SHIPPING ADDRESS");
