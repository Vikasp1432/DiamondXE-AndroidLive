...
public class PlcaeOrderKYCVerificationDocUploadActivity extends SuperActivity implements RecyclerInterface, DialogItemClickInterface {
    ...
    private ImageView back_img,  company_gst_no_verify_img, iec_no_verify_img,aadhaar_no_verify_img,pan_card_no_verify_img,passport_no_verify_img,
            driving_licence_no_verify_img,
            auth_pan_card_no_verify_img;
    ...
    private TextView company_gst_doc_verify_img, iec_doc_verify_img,aadhaar_doc_front_verify_img,aadhaar_doc_back_verify_img,pan_doc_verify_img,
            auth_pan_doc_verify_img,passport_doc_front_verify_img, passport_doc_back_verify_img,driving_licence_doc_verify_img, total_amount_tv;

    private TextView iec_doc_verify_error_tv, company_gst_doc_verify_error_tv, aadhaar_doc_front_verify_error_tv, aadhaar_doc_back_verify_error_tv,
            pan_doc_verify_error_tv, auth_pan_doc_verify_error_tv, passport_doc_back_verify_error_tv, passport_doc_front_verify_error_tv, driving_licence_doc_verify_error_tv;
    ...
    passportFrontDocBase64Url="", passportBackDocBase64Url="", drivingLicenceDocBase64Url="",authPanCardDocBase64Url="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_place_order_kyc_verification_doc_upload);
    ...
    void kycFieldVisibleHide()
    {
        ...
        if(Constant.companyPanCardVerifiedInd.equalsIgnoreCase("1"))
        {
            ...
            pan_card_main_lin   .setVisibility(View.VISIBLE);
        }
        ...
        if(Constant.companyGstCertificateVerifiedInd.equalsIgnoreCase("1"))
        {
            ...
            company_gst_main_lin.setVisibility(View.VISIBLE);
        }
        ...
        if(Constant.iecCardVerifiedInd.equalsIgnoreCase("1"))
        {
            ...
            iec_main_lin.setVisibility(View.VISIBLE);
        }
    ...
    public void onClick(View view)
    {
        ...
        {
            Utils.hideKeyboard(activity);
            Toast.makeText(activity, getResources().getString(R.string.please_upload_doc), Toast.LENGTH_SHORT).show();
        }
        ...
        else if(id == R.id.dob_lin)
        {
            ...
            CommonUtility.datePicker(context, PlcaeOrderKYCVerificationDocUploadActivity.this, dob, "dob", 0, System.currentTimeMillis());
        }
