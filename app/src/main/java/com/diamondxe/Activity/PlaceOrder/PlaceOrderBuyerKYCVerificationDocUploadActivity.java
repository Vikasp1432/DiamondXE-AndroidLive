...
public class PlaceOrderBuyerKYCVerificationDocUploadActivity extends SuperActivity implements RecyclerInterface, DialogItemClickInterface {
    ...
    private TextView company_gst_no_error_tv, gst_dov_upload_tv, iec_no_require_tv, iec_doc_upload_tv,aadhaar_no_required,aadhaar_doc_upload_front_tv,
            ...
            driving_licence_no_required,driving_licence_doc_upload_tv,date_of_birth_tv,submit_tv,auth_pan_card_no_required,auth_pan_card_doc_upload_tv,
            total_amount_tv;
    ...
    private TextView aadhaar_doc_front_verify_error_tv, aadhaar_doc_back_verify_error_tv, auth_pan_doc_verify_error_tv, passport_doc_front_verify_error_tv, passport_doc_back_verify_error_tv,
            driving_licence_doc_verify_error_tv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_place_order_buyer_kyc_verification_doc_upload);
        ...
        Log.e("----userCountryCode------ : ", userCountryCode.toString());
    ...
    public void onClick(View view)
    {
        ...
        else if(id == R.id.payment_card_view)
        {
            ...
            {
                Toast.makeText(activity, getResources().getString(R.string.please_upload_doc_first), Toast.LENGTH_SHORT).show();
            }else{}
        }
        ...
        else if(id == R.id.dob_lin)
        {
            ...
            CommonUtility.datePicker(context, PlaceOrderBuyerKYCVerificationDocUploadActivity.this, dob, "dob", 0, System.currentTimeMillis());
        }
