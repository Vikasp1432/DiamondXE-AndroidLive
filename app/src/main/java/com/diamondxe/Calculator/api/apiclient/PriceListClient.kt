...
object PriceListClient {
    private val builder = Retrofit.Builder()
        .baseUrl(Constants.URL_PRICE_LIST)
    ...
    @Volatile
    private var instance : PriceListApiInterface? = null
    fun getInstance() : PriceListApiInterface = instance ?: synchronized(this) {
        ...
        retrofit.create(PriceListApiInterface::class.java)
    }
