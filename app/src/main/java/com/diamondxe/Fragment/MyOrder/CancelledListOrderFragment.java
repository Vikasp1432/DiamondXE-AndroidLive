...
import com.diamondxe.Activity.MyOrder.CancelledOrderSummaryScreenActivity;
import com.diamondxe.Adapter.MyOrder.CancelledOrderListAdapter;
...
public class CancelledListOrderFragment extends SuperFragment implements TwoRecyclerInterface {
    ...
    private CancelledOrderListAdapter adapter;
    ...
    public CancelledListOrderFragment() {}
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_cancelled_list_order, container, false);
    ...
    public void getOrderListAPI(boolean showLoader)
    {
        if (Utils.isNetworkAvailable(context))
        {
            ...
            urlParameter.put("orderType", "Cancelled");
    ...
    public void getOrderDetailsAPI(boolean showLoader, String orderID)
    {
        if (Utils.isNetworkAvailable(context))
        {
            ...
            urlParameter.put("cancelOrderId", orderID);
    ...
    public void getSuccessResponce(JSONObject jsonObject, int service_ID) {
        ...
        try {
            Log.v("------Diamond----- : ", "--------JSONObjectCancelled-------- : " + jsonObject);
                ...
                case ApiConstants.ORDER_LIST_ID:
                    if (jsonObjectData.optString("status").equalsIgnoreCase("1"))
                    {
                        ...
                        for (int i = 0; i < details.length(); i++)
                        {
                            ...
                            model.setCancelReturnOrderId(CommonUtility.checkString(objectCodes.optString("cancel_return_order_id")));
                        ...
                        if(pageNo == 1)
                        {
                            adapter = new CancelledOrderListAdapter(modelArrayList,context,this);
    ...
    public void itemClick(int parantPosition, int chiledPosition, String action)
    {
        ...
        {
            getOrderDetailsAPI(false, modelArrayList.get(parantPosition).getCancelReturnOrderId());
        }
        else if(action.equalsIgnoreCase("orderSummary"))
        {
            Constant.orderID = modelArrayList.get(parantPosition).getCancelReturnOrderId();
            Intent intent = new Intent(activity, CancelledOrderSummaryScreenActivity.class);
