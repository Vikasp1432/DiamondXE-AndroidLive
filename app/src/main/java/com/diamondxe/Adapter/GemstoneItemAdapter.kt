...
class GemstoneItemAdapter(
    private val list: List<GemItemsAttribute>,
    private val context: Context,
    private val recyclerInterface: RecyclerInterface
) : RecyclerView.Adapter<GemstoneItemAdapter.RecycleViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecycleViewHolder, position: Int) {
        ...
        holder.color_type_tv.setOnClickListener {
            recyclerInterface.itemClick(position, "Gemitem")
        }
    }
