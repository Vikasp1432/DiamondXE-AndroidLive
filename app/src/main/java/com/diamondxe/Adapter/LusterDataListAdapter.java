...
public class LusterDataListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public LusterDataListAdapter(ArrayList<AttributeDetailsModel> list, Context context, RecyclerInterface recyclerInterface) {
        this.list = list;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder (ViewGroup parent, int viewType) {
            ...
            View v = LayoutInflater.from (parent.getContext ()).inflate (R.layout.row_luster_data_list, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, @SuppressLint("RecyclerView") final int position) {
        ...
        holder.root_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                recyclerInterface.itemClick(position,"lusterType");
            }
        });
