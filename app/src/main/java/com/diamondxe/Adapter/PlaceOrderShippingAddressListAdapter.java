...
public class PlaceOrderShippingAddressListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PlaceOrderShippingAddressListAdapter(ArrayList<AddressListModel> list, Context context, RecyclerInterface recyclerInterface, int width) {
        this.list = list;
