...
class GemTreatmentAdapter(
    private val list: List<GemTreatmentAttribute>,
    private val context: Context,
    private val recyclerInterface: RecyclerInterface
) : RecyclerView.Adapter<GemTreatmentAdapter.RecycleViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecycleViewHolder, position: Int) {
        ...
        holder.color_type_tv.setOnClickListener {
            recyclerInterface.itemClick(position, "gemTreatment")
        }
    }
