...
public class ReturnOrderDetailsListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ReturnOrderDetailsListAdapter(ArrayList<MyOrderListModel> list, Context context, TwoRecyclerInterface recyclerInterface) {
        this.list = list;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder (ViewGroup parent, int viewType) {
            ...
            View v = LayoutInflater.from (parent.getContext ()).inflate (R.layout.row_order_history_details, parent, false);
    ...
    class RecycleViewHolder extends RecyclerView.ViewHolder {
        TextView date_time_tv, name_tv, stock_no_tv, return_policy_tv, diamond_type_tv, order_number_tv,
