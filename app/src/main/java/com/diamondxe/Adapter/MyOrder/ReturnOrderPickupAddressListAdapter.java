...
public class ReturnOrderPickupAddressListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ReturnOrderPickupAddressListAdapter(ArrayList<AddressListModel> list, Context context, TwoRecyclerInterface recyclerInterface, int width) {
        this.list = list;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, @SuppressLint("RecyclerView") final int position) {
        ...
        holder.root_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                recyclerInterface.itemClick(position, 0,"selectShippingAddress");
            }
        });
        ...
        holder.edit_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                recyclerInterface.itemClick(position, 0,"editAddress");
            }
        });
        ...
        holder.delete_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                recyclerInterface.itemClick(position, 0,"deleteAddress");
