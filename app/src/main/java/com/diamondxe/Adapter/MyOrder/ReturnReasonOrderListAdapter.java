...
public class ReturnReasonOrderListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ReturnReasonOrderListAdapter(ArrayList<CancelOrderReasonListModel> list, Context context, TwoRecyclerInterface recyclerInterface, int parentPosition) {
        this.list = list;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, @SuppressLint("RecyclerView") final int position) {
        ...
        holder.root_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                recyclerInterface.itemClick(parentPosition,position, "reason");
            }
        });
    }
