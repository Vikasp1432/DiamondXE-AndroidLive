...
public class ReturnOrderSummaryListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ReturnOrderSummaryListAdapter(ArrayList<MyOrderListModel> list, Context context, TwoRecyclerInterface recyclerInterface, String type) {
        this.list = list;
