...
public class PlaceOrderBillingAddressListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PlaceOrderBillingAddressListAdapter(ArrayList<AddressListModel> list, Context context, RecyclerInterface recyclerInterface, int width) {
        this.list = list;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, @SuppressLint("RecyclerView") final int position) {
        ...
        if(Constant.showRadioButtonForSelectAddress.equalsIgnoreCase("yes"))
        {
            holder.set_is_default_btn.setVisibility(View.VISIBLE);
        }
        else{
        ...
        holder.root_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                recyclerInterface.itemClick(position, "selectBillingAddress");
            }
        });

        holder.set_is_default_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        holder.edit_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                recyclerInterface.itemClick(position, "editBillingAddress");
        ...
        holder.delete_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                recyclerInterface.itemClick(position, "deleteBillingAddress");
