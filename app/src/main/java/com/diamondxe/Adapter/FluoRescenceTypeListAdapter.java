...
import com.diamondxe.Beans.CertificateTypeModel;
import com.diamondxe.Beans.FluoRescenceTypeModel;
...
public class FluoRescenceTypeListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public FluoRescenceTypeListAdapter(ArrayList<AttributeDetailsModel> list, Context context, RecyclerInterface recyclerInterface) {
        this.list = list;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder (ViewGroup parent, int viewType) {
            ...
            View v = LayoutInflater.from (parent.getContext ()).inflate (R.layout.row_fluorescence_type_list, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, @SuppressLint("RecyclerView") final int position) {
        ...
        holder.root_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                recyclerInterface.itemClick(position,"fluoresenceType");
            }
        });
