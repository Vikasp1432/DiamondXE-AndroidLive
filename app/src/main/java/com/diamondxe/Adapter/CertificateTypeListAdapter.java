...
import com.diamondxe.Beans.ClarityTypeModel;
...
public class CertificateTypeListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CertificateTypeListAdapter(ArrayList<AttributeDetailsModel> list, Context context, RecyclerInterface recyclerInterface) {
        this.list = list;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder (ViewGroup parent, int viewType) {
            ...
            View v = LayoutInflater.from (parent.getContext ()).inflate (R.layout.row_certificate_type_list, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, @SuppressLint("RecyclerView") final int position) {
        ...
        holder.root_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                recyclerInterface.itemClick(position,"certificateType");
            }
        });
