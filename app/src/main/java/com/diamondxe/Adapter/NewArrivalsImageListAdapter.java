...
public class NewArrivalsImageListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    ArrayList<NewArrivalsImageModel> list;
    Context context;
    int last;
    public ArrayList<NewArrivalsImageModel> arraylist;
    RecyclerInterface recyclerInterface;

    public NewArrivalsImageListAdapter(ArrayList<NewArrivalsImageModel> list, Context context, RecyclerInterface recyclerInterface) {
        this.list = list;
        this.context = context;
        this.arraylist = new ArrayList<NewArrivalsImageModel>();
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, @SuppressLint("RecyclerView") final int position) {
        ...
        holder.root_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                recyclerInterface.itemClick(position,"newArrivalsDetails");
            }
        });
