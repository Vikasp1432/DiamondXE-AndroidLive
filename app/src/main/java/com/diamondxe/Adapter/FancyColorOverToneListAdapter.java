...
public class FancyColorOverToneListAdapter extends ArrayAdapter<AttributeDetailsModel> {

    private static final int HINT_POSITION = 0;
    private String hint;
    private Context context;

    public FancyColorOverToneListAdapter(Context context, ArrayList<AttributeDetailsModel> algorithmList, String hint) {
    ...
    private View initView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.row_fancy_color_overtone_list, parent, false);
        }
