...
public class CrownToDataListAdapter extends ArrayAdapter<AttributeDetailsModel> {

    private static final int HINT_POSITION = 0;
    private String hint;
    Context context;

    public CrownToDataListAdapter(Context context, ArrayList<AttributeDetailsModel> algorithmList, String hint) {
