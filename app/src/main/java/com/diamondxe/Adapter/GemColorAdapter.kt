...
class GemColorAdapter(
    private val list: List<GemColorAttribute>,
    private val context: Context,
    private val recyclerInterface: RecyclerInterface
) : RecyclerView.Adapter<GemColorAdapter.RecycleViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecycleViewHolder, position: Int) {
        ...
        holder.color_type_tv.setOnClickListener {
            recyclerInterface.itemClick(position, "gemcolor")
        }
    }
