...
public class PavillionToDataListAdapter extends ArrayAdapter<AttributeDetailsModel> {

    private static final int HINT_POSITION = 0;
    private String hint;
    Context context;

    public PavillionToDataListAdapter(Context context, ArrayList<AttributeDetailsModel> algorithmList, String hint) {
