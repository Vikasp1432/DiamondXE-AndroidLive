...
class GemOriginAdapter(
    private val list: List<GemOriginAttribute>,
    private val context: Context,
    private val recyclerInterface: RecyclerInterface
) : RecyclerView.Adapter<GemOriginAdapter.RecycleViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecycleViewHolder, position: Int) {
        ...
        holder.color_type_tv.setOnClickListener {
            recyclerInterface.itemClick(position, "GemOrigin")
        }
    }
