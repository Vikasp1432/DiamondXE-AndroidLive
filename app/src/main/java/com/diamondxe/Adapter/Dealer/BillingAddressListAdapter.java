...
public class BillingAddressListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public BillingAddressListAdapter(ArrayList<AddressListModel> list, Context context, RecyclerInterface recyclerInterface, int width) {
        this.list = list;
