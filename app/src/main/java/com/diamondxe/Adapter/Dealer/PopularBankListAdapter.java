...
public class PopularBankListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public PopularBankListAdapter(ArrayList<BankNEFTListModel> list, Context context, RecyclerInterface recyclerInterface) {
        this.list = list;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder (ViewGroup parent, int viewType) {
            ...
            View v = LayoutInflater.from (parent.getContext ()).inflate (R.layout.row_popular_bank_name, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, @SuppressLint("RecyclerView") final int position) {
        ...
        holder.bank_name_tv.setVisibility(View.GONE);
        holder.bank_name_tv.setText(list.get(position).getBankName());

        holder.root_layout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                recyclerInterface.itemClick(position,"popularSelectBank");
            }
        });
    }
