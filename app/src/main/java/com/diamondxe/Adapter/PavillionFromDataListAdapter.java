...
public class PavillionFromDataListAdapter extends ArrayAdapter<AttributeDetailsModel> {

    private static final int HINT_POSITION = 0;
    private String hint;
    Context context;

    public PavillionFromDataListAdapter(Context context, ArrayList<AttributeDetailsModel> algorithmList, String hint) {
