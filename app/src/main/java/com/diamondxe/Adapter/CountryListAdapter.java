...
public class CountryListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CountryListAdapter(ArrayList<CountryListModel> list, Context context, RecyclerInterface recyclerInterface, String showCountryCode) {
        this.list = list;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, @SuppressLint("RecyclerView") final int position) {
        ...
        if(showCountryCode.equalsIgnoreCase("yes"))
        {
            holder.currency_name_tv.setText(list.get(position).getPhoneCode() + " " + list.get(position).getTitle());
        }
        else{
            holder.currency_name_tv.setText(list.get(position).getTitle());
        }
        ...
        holder.root_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                recyclerInterface.itemClick(position,"countryName");
            }
        });
