...
class GemstoneCuttingAdapter(
    private val list: List<GemCuttingAttribute>,
    private val context: Context,
    private val recyclerInterface: RecyclerInterface
) : RecyclerView.Adapter<GemstoneCuttingAdapter.RecycleViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RecycleViewHolder, position: Int) {
        ...
        holder.color_type_tv.setOnClickListener {
            recyclerInterface.itemClick(position, "Gemcutting")
        }
    }
