...
public class DiamondShapeImageListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public DiamondShapeImageListAdapter(ArrayList<DiamondShapeImageModel> list, Context context, RecyclerInterface recyclerInterface) {
        this.list = list;
