...
public class DiamondCaratTypeListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    ArrayList<DiamondShapeImageModel> list;
    Context context;
    int last;
    public ArrayList<DiamondShapeImageModel> arraylist;
    RecyclerInterface recyclerInterface;

    public DiamondCaratTypeListAdapter(ArrayList<DiamondShapeImageModel> list, Context context, RecyclerInterface recyclerInterface) {
        this.list = list;
        this.context = context;
        this.arraylist = new ArrayList<DiamondShapeImageModel>();
    ...
    public RecyclerView.ViewHolder onCreateViewHolder (ViewGroup parent, int viewType) {
            ...
            View v = LayoutInflater.from (parent.getContext ()).inflate (R.layout.row_diamond_carat_type_list, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, @SuppressLint("RecyclerView") final int position) {
        ...
        holder.type_tv.setText(list.get(position).getCarat());
       ...
       /* if(list.get(position).isFirstPosition())
        ...
        holder.root_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                recyclerInterface.itemClick(position,"caratType");
            }
        });
